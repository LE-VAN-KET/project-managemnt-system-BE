...
public interface TestConstants {
    String USER_NAME = "levanket";
    String PASSWORD = "Ket@1512001";
    String FULL_NAME = "Le Van Ket";

    LoginUserRequest VALID_USER_LOGIN = new LoginUserRequest(USER_NAME, PASSWORD);
    LoginUserRequest INVALID_USER_LOGIN = new LoginUserRequest("invalid-user", "wrong-password");
    Collection<? extends GrantedAuthority> roles = new ArrayList<>(Collections.singleton(new SimpleGrantedAuthority("ROLE_USER")));
    CustomUserPrincipal USER_PRINCIPAL = new CustomUserPrincipal(USER_NAME, PASSWORD, "3fa85f64-5717-4562-b3fc-2c963f66afa6",
    ...
    TokenProperties TOKEN_PROPERTIES = new TokenProperties(360L, 1800L);
}
